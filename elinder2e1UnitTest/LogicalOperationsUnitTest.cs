...
namespace elinder2e1UnitTest
{
    ...
    public class LogicalOperationsUnitTest
    {
        ...
        {
            Assert.IsFalse(LogicalOperations.q09(0, 1));
        }

        [TestMethod]
        public void TestQ10ValidRanges()
        {
            Assert.IsFalse(LogicalOperations.q10(1, 2, 3, 4));
        }
        [TestMethod]
        ...
        {
            Assert.IsFalse(LogicalOperations.q10(1, 1, 3, 4));
        }
        [TestMethod]
        ...
        {
            Assert.IsTrue(LogicalOperations.q12(false, 24.99m, 1.0f));
        }
        [TestMethod]
