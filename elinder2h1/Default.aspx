<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="elinder2h1._Default" %>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox2BResult" runat="server" Enabled="False" OnTextChanged="TextBox2BResult_TextChanged"></asp:TextBox>
                ...
                <asp:TextBox ID="TextBox3BResult" runat="server" Enabled="False" OnTextChanged="TextBox2BResult_TextChanged" Width="30px"></asp:TextBox>
                <asp:TextBox ID="TextBox3CResult" runat="server" Enabled="False" OnTextChanged="TextBox2BResult_TextChanged" Width="30px"></asp:TextBox>
</div>            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox6B" runat="server" OnTextChanged="TextBox2BResult_TextChanged" Width="30px">11</asp:TextBox>
                <asp:TextBox ID="TextBox6C" runat="server" OnTextChanged="TextBox2BResult_TextChanged" Width="30px">01</asp:TextBox>
                ...
                <asp:TextBox ID="TextBox7" runat="server" Enabled="False">November 1, 2019</asp:TextBox>
                ...
                <asp:TextBox ID="TextBox9A" runat="server" Width="89px">1/13/2019</asp:TextBox>
                <asp:TextBox ID="TextBox9B" runat="server" Width="84px">12/12/2012</asp:TextBox>
                ...
                <asp:TextBox ID="TextBox10A" runat="server" Width="89px">1/13/2019</asp:TextBox>
                <asp:TextBox ID="TextBox10B" runat="server" Width="84px">12/12/2012</asp:TextBox>
        ...
        <div class="col-md-6">
            <h2>String Methods</h2>
                ...
                <asp:TextBox ID="TextBox16" runat="server">308 Pioneer Rd</asp:TextBox>
                ...
                <asp:TextBox ID="TextBox17" runat="server" Width="164px">308 Pioneer Rd</asp:TextBox>
                ...
                <asp:TextBox ID="TextBox19" runat="server" Width="201px">111 1st st, Lake City, MN 55041</asp:TextBox>
                ...
                <asp:TextBox ID="TextBox20Result" runat="server" Enabled="False"></asp:TextBox>
</div>
