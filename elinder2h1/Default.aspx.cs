...
namespace elinder2h1
{
    public partial class _Default : Page
    {
        ...
        protected void TextBox2BResult_TextChanged(object sender, EventArgs e)
        {
            ...
            TextBox20Result.Text = Ex2hCalculations.StringCalc10(TextBox17.Text, TextBox18.Text, TextBox19.Text);
